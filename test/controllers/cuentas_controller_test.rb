...
class CuentasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cuenta" do
    assert_difference('Cuenta.count') do
      post cuentas_url, params: { cuenta: { direccion: @cuenta.direccion, saldo: @cuenta.saldo } }
    end
  ...
  test "should update cuenta" do
    patch cuenta_url(@cuenta), params: { cuenta: { direccion: @cuenta.direccion, saldo: @cuenta.saldo } }
